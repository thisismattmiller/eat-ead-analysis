...
<html lang="en">
  ...
  <p>
  	Matching <a href="http://archives2.getty.edu:8082/xtf/view?docId=ead/940003/940003.xml;chunk.id=dsc_1;brand=default" style="color:blue">E.A.T. archive EAD</a> to Semlab <a href="http://base.semlab.io" style="color:blue">Wikibase</a>. The number in parenthese: "Robert Rauschenberg (194)" is the nubmer of text fragments (blocks) we have in the wikibase.
  </p>

  <span style="display:inline-block; height:20px; width:20px; background-color:aliceblue; border: solid 1px black;"></span> = postiive match to Semlab wikibase<br>
  <span style="display:inline-block; height:20px; width:20px; background-color:#ffe7bc; border: solid 1px black;"></span> = low quality label match to Semlab wikibase<br>
  <span style="display:inline-block; height:20px; width:20px; background-color:#ffc6bb; border: solid 1px black;"></span> = person not found in Semlab wikibase<br>
